...
// The published paths (`esm/index.js`, `cjs/index.js`, and the `.d.ts` beside each)
// are the ones the three `tsc` passes used to emit — keep them byte-for-byte
// addressable or every consumer's deep import breaks.
//
...
export default defineConfig([
	...
	},
	{
		...
		format: 'cjs',
		outDir: 'cjs',
		// rolldown's floor is ES2015; the old `tsc` CJS pass targeted ES5. Nothing here
		// needs the difference and every runtime that can load CJS today is well past
		// ES2015 — noted as a patch-level change in the changeset.
		target: 'es2015',
		hooks: {
